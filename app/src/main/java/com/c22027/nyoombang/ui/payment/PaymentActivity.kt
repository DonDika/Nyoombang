...
class PaymentActivity : AppCompatActivity(), TransactionFinishedCallback {
    ...
    private fun setListener() {
        //get data detail user from db using intent
        //userDetails = ...
    ...
    private fun initTransactionRequest(payment: Double): TransactionRequest {
        val transactionRequest = TransactionRequest("Nyoombang : " + System.currentTimeMillis().toString(), payment)
    ...
    private fun initCustomerDetails(): CustomerDetails {
        ...
        customerDetails.firstName = "Dika"
        customerDetails.email = "mail@mail.com"
        customerDetails.customerIdentifier = "mail@mail.com"
