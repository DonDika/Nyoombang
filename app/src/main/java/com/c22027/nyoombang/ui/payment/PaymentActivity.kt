...
//        customerDetails.firstName = pref.getString(Utilization.PREF_USERNAME)
//        customerDetails.email = "mail@mail.com" //from firebase
...
//        pref.put(Utilization.PREF_ORDER_ID, orderId)
